...
<Info>
  Medusa Cloud only deploys the **backend**. The admin panel, vendor panel,
  and storefront must be deployed separately (for example, on Vercel,
  Netlify, or your own infrastructure) and pointed at the deployed backend
  URL.
</Info>
